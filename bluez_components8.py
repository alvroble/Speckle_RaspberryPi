...
class TxCharacteristic(Characteristic):
    def __init__(self, bus, index, service, queue):
        ...
        self.queue = queue
        GObject.io_add_watch(self.queue._reader, GObject.IO_IN, self.on_console_input)
...
class RxCharacteristic(Characteristic):
    ...
    def WriteValue(self, value, options):
        print('New value arrived: ' + repr(value))
        ...
        #byte = value[0]
        print('\tControl byte value: ' + value)

        if value == '10':
            print('Sent value for start')
            self.queue.put(10)
        if value == '20':
            print('Sent value for stop')
            self.queue.put(20)
...
class UartService(Service):    
    ...
    def __init__(self, bus, index, q_HR, q_ctrl):
        Service.__init__(self, bus, index, UART_SERVICE_UUID, True)
        self.add_characteristic(TxCharacteristic(bus, 0, self, q_HR))
        self.add_characteristic(RxCharacteristic(bus, 1, self, q_ctrl))
...
class BatteryLevelCharacteristic(Characteristic):
    ...
    """
    BATTERY_LVL_UUID = '00002a19-0000-1000-8000-00805f9b34fb'
    ...
    def __init__(self, bus, index, service):
        ...
        self.notifying = False
        try:        
            f = open('BAT_LEVEL.txt','r')
            self.battery_lvl = int(f.read())
            f.close()
        except:
            self.battery_lvl = -1
        GObject.timeout_add(70000, self.drain_battery)
